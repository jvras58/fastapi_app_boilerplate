...
from api.transaction.schemas import (
...
@router.post(
    '/', status_code=HTTP_STATUS.HTTP_201_CREATED, response_model=TransactionSchema,  # noqa: E501
)
...
@router.get(
    '/', status_code=HTTP_STATUS.HTTP_200_OK, response_model=TransactionListSchema,  # noqa: E501
)
...
@router.delete('/{transaction_id}', response_model=MessageSchema)
